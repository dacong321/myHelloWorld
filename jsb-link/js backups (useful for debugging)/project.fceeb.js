...
var i = cc._decorator, c = i.ccclass, s = i.property, u = t("./init"), l = t("./init"), p = t("./testTs"), f = function(t) {
n(e, t);
function e() {
...
var t = l.Type.sd;
console.log(t);
jsb.reflection.callStaticMethod("org.cocos2dx.javascript/Activity", "openTest", "()V");
};
